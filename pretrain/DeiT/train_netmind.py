...
if __name__ == '__main__':
    ...
    with multi_worker_mirrored_strategy.scope():
        ...
        learning_rate_schedules = CosineDecayWithWarmUP(initial_learning_rate=args.learning_rate * n_workers,
                                                        ...
                                                        alpha=args.minimum_learning_rate,
    ...
    train_data_iterator = multi_worker_mirrored_strategy.experimental_distribute_dataset(dataset_train)

    #  eval
    dataset_eval = test_iterator().batch(global_batch_size, drop_remainder=True)
    test_data_iterator = multi_worker_mirrored_strategy.experimental_distribute_dataset(dataset_eval)
    """
