...
def main():
    ...
    with training_args.strategy.scope():
        ...
        if training_args.do_train:
            ...
            # callbacks = [ModelCheckpoint(filepath=training_args.output_dir + "/mybest_epoch{epoch:02d}_accuracy{val_accuracy:.2f}",
        ...
        if training_args.do_eval:
            ...
            for raw_dataset, tf_dataset, task in zip(raw_datasets, tf_datasets, tasks):
                ...
                with open(output_predict_file, "a+") as writer:
                    writer.write(f"Evaluation metrics ({task}): {eval_metrics} \n")
