...
CUDA_VISIBLE_DEVICES="0" python test_multi_worker.py  --category_num=1000 \
                          --per_device_train_batch_size=100 --weight_decay=0.0001 --label_smoothing=0.1 --train_num=12811 \
                          --test_num=500 --learning_rate=0.05 --minimum_learning_rate=0.0001 \
                          --save_steps=2 --data="/data/resnet50" --num_train_epochs=2 --warmup_steps=5 \
