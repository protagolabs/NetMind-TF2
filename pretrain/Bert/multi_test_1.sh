...
CUDA_VISIBLE_DEVICES="1" python $entry_point  --category_num=1000 \
                          --label_smoothing=0.1 --train_num=12811 \
                          ...
                          --num_train_epochs=1 --per_device_eval_batch_size=9 --learning_rate=0.0001 --warmup_proportion=0.1 \
                          ...
                          --tokenizer_name=bert-base-uncased --model_name_or_path="" --per_device_train_batch_size=16
