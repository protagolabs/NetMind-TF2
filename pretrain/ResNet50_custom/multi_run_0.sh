...
CUDA_VISIBLE_DEVICES="0" python train_netmind.py  --category_num=1000 \
                          ...
                          --logging_steps=10 --fp16=False  --model_name_or_path=empty --train_list_path=data/train_test.txt \
